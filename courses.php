    ...
    <div class="container position-relative pt-100">
        ...
        <div class="row justify-content-center mt-20">
            <div data-aos="fade-up" data-aos-duration="1000" class="col-sm-6 col-lg-4 mt-40">
                ...
                <a href="ielts.php" class="nameBoxWrapper">
                        <div class="nameBox">
                            <h6>IELTS</h6>
                        </div>
                    </a>
            ...
            <div data-aos="fade-up" data-aos-duration="2000" class="col-sm-6 col-lg-4 mt-40">
                ...
                <a href="oet.php" class="nameBoxWrapper">
                        <div class="nameBox">
                            <h6>OET</h6>
                        </div>
                </a>
...
<section class="commonSection pt-0 pb-80">
    <div class="container">
        <div class="row justify-content-center">
...
<section class="testimonialSection pt-90 pb-90">
